...
function dselect(el, option = {}) {
  ...
  const searchInput = search ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control drop-down-search" placeholder="Search" autofocus>` : ''
    ...
    <div class="dropdown ${classElement} ${additionalClass}">
      ...
      <div class="dropdown-menu">
        <div class="d-flex flex-column">
          ...
          <div class="${classNoResults} d-none p-2">No Results Found</div>
        </div>
      </div>
      ${clearBtn}
    </div>
